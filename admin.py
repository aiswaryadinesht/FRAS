...
class main:
    ...
    def login(self):
        ...
        if result:
            ...
            ms.showerror('Oops!','Please Check Your Username and Password.')
    ...
    def widgets(self):
        ...
        self.head = Label(self.master,text = 'ADMIN PORTAL',font = ('',15),pady = 10)
        self.head.pack()
        ...
        Label(self.logf,text = ' ',font = ('',10),pady=2,padx=2).grid(sticky = W)
        
        Button(self.logf,text = ' Login ',bd = 3 ,font = ('',10),padx=5,pady=5,command=self.login).grid(row=3,column=0)
        Button(self.logf,text = ' Create Account ',bd = 3 ,font = ('',10),padx=5,pady=5,command=self.cr).grid(row=3,column=1)
        self.logf.pack()
        ...
        Button(self.crf,text = 'Create Account',bd = 3 ,font = ('',10),padx=5,pady=5,command=self.new_user).grid()
        Button(self.crf,text = 'Go to Login',bd = 3 ,font = ('',10),padx=5,pady=5,command=self.log).grid(row=2,column=1)
